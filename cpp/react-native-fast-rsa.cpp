...
namespace fastRSA {
    jsi::Value call(jsi::Runtime &runtime, const jsi::String &nameValue,
        ...
        auto response = RSABridgeCall(name, data, size);
...
//        jsiRuntime.global().setProperty(jsiRuntime, "FastRSA", std::move(object));
        jsiRuntime.global().setProperty(jsiRuntime, "FastRSACallPromise",
                                        std::move(bridgeCallPromise));
        jsiRuntime.global().setProperty(jsiRuntime, "FastRSACallSync",
